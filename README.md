...
- **信心度三層**:`confirmed`（TU/後期魔物的 MR 門檻,Game8 攻略確認的遊戲常數,2.3%）/ `inferred`（任務星級推導,58.5%）/ `unverified`（無來源魔物可推導,退回 rarity 近似,39.3%）。覆蓋率細節與待補清單見 [docs/DATA-COVERAGE.md](docs/DATA-COVERAGE.md)
